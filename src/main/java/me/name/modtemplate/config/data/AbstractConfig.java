...
public class AbstractConfig {
    ...
    protected AbstractConfig(File file, boolean addInternalProperties) {
        ...
        try {
            ...
            ModTemplate.LOGGER.error("Failed to sort in declaration order", e);
        }
    ...
    public void save() {
        try {
            ...
            ModTemplate.LOGGER.error("Failed in updating config fields", e);
        }
        if (config.hasChanged()) config.save();
    }
    ...
    public void saveOnlyOneProperty(String name) {
        ...
        try {
            ...
            ModTemplate.LOGGER.error("Failed in updating config field", e);
        }
        if (config.hasChanged()) config.save();
    }
