...
import me.name.modtemplate.config.data.ConfigCategoryContainer;
import me.name.modtemplate.config.data.ConfigFieldContainer;
import me.name.modtemplate.config.gui.elements.*;
...
import me.name.modtemplate.utils.DelayedTask;
...
public class ConfigScreen extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        fontRendererObj.drawString(ModTemplate.NAME + " - " + ModTemplate.VERSION, menuDrawX, INNER_TOP + ((HEADER_HEIGHT - fontRendererObj.FONT_HEIGHT) / 2) + 1, ModResources.WHITE);
